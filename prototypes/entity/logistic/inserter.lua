...
--Crude Inserter
{
	...
	flags = {"placeable-neutral", "placeable-player", "player-creation"},
	minable = {hardness = 0.2, mining_time = 0.5, result = "crude-inserter"},
	max_health = 50,
	corpse = "small-remnants",
	allow_custom_vectors = false,
	resistances =
	...
	hand_base_picture =
	{
		filename = "__xander-mod__/graphics/entity/logistic/crude-inserter/hand-base.png",
		priority = "extra-high",
		width = 8,
		height = 34,
		hr_version =
		{
			filename = "__xander-mod__/graphics/entity/logistic/crude-inserter/hr-hand-base.png",
			priority = "extra-high",
			width = 32,
			height = 136,
			scale = 0.25
	...
	hand_closed_picture =
	{
		filename = "__xander-mod__/graphics/entity/logistic/crude-inserter/hand-closed.png",
		priority = "extra-high",
		width = 18,
		height = 41,
		hr_version =
		{
			filename = "__xander-mod__/graphics/entity/logistic/crude-inserter/hr-hand-closed.png",
			priority = "extra-high",
			width = 72,
			height = 164,
			scale = 0.25
	...
	hand_open_picture =
	{
		filename = "__xander-mod__/graphics/entity/logistic/crude-inserter/hand-open.png",
		priority = "extra-high",
		width = 18,
		height = 41,
		hr_version =
		{
			filename = "__xander-mod__/graphics/entity/logistic/crude-inserter/hr-hand-open.png",
			priority = "extra-high",
			width = 72,
			height = 164,
			scale = 0.25
	...
	platform_picture =
	{
		sheet =
		{
			filename = "__xander-mod__/graphics/entity/logistic/crude-inserter/platform.png",
			priority = "extra-high",
			width = 46,
			height = 46,
			shift = {0.09375, 0},
			hr_version =
			{
				filename = "__xander-mod__/graphics/entity/logistic/crude-inserter/hr-platform.png",
				priority = "extra-high",
				width = 105,
				height = 79,
				shift = util.by_pixel(1.5, 7.5-1),
