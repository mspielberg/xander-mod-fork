...
--Base "electronics"
data.raw.technology["electronics"].effects = {{type = "unlock-recipe", recipe = "secondary-1"}, {type = "unlock-recipe", recipe = "data-1"}, 
	{type = "unlock-recipe", recipe = "electronic-circuit"}, {type = "unlock-recipe", recipe = "control-1"}}
data.raw.technology["electronics"].prerequisites = {"substrate_1", "soldering_1"}
...
data.raw.technology["advanced-electronics"].effects = {{type = "unlock-recipe", recipe = "secondary-2"}, 
	{type = "unlock-recipe", recipe = "data-2"}, {type = "unlock-recipe", recipe = "advanced-circuit"}, 
	{type = "unlock-recipe", recipe = "control-2"}, {type = "unlock-recipe", recipe = "science-pack-3"}}
data.raw.technology["advanced-electronics"].prerequisites = {"electronics", "substrate_2", "semiconductors_1", "rubber-a"}
...
data.raw.technology["advanced-electronics-2"].effects = {{type = "unlock-recipe", recipe = "secondary-3"}, {type = "unlock-recipe", recipe = "data-3"}, 
	{type = "unlock-recipe", recipe = "processing-unit"}, {type = "unlock-recipe", recipe = "control-3"}, 
...
--Substrates 1
{
	...
	prerequisites = {"wire_1", "sulfuric-acid-a"},
	unit =
	{
		count = 20,
		ingredients =
...
--Substrates 2
{
	...
	prerequisites = {"substrate_1", "plastics", "phenolic-resin", "nitric-acid-a"},
	unit =
	{
		count = 200,
		ingredients =
...
--Substrates 3
{
	...
	effects =
	{
		...
		{
			type = "unlock-recipe",
			recipe = "metallized-2-b"
		},
		{
			type = "unlock-recipe",
			recipe = "metallized-1-c"
		}
	},
...
--Soldering 1
{
	...
	prerequisites = {"wire_1", "reactor_0"},
	unit =
	{
		count = 10,
		ingredients =
...
--Soldering 3 - Silver Solder
{
	...
	prerequisites = {"soldering_2", "solder-alloy_2"},
	unit =
	{
		count = 150,
		ingredients =
