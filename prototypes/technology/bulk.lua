...
data.raw.technology["sulfur-processing"].prerequisites = {"sulfuric-acid-a", "oil-processing"}
...
--Alloy Steel A
{
	...
	prerequisites = {"forging-steel", "nickel-refining", "vanadium-refining", "tungsten-refining"},
	unit =
	{
		count = 200,
		ingredients =
...
--[[Standard 60 Lead : 40 Tin Soldering Alloy
{
	type = "technology",
	name = "solder-alloy_1",
	icon = "__xander-mod__/graphics/technology/bulk/solder-alloy_1.png",
	icon_size = 128,
	effects =
	{
...
--Improved Tin-Silver-Copper Soldering Alloy
{
	type = "technology",
	name = "solder-alloy_2",
	icon = "__xander-mod__/graphics/technology/bulk/solder-alloy_2.png",
	icon_size = 128,
	effects =
	{
		{
	...
	prerequisites = {"soldering_1", "copper-refining", "silver-refining"},
	unit =
	{
		count = 150,
		ingredients =
...
--Cement A, with Lime
{
	...
	prerequisites = {"advanced-material-processing-2", "bauxite-sediment", "calcium-processing"},
	unit =
	{
		count = 150,
		ingredients =
