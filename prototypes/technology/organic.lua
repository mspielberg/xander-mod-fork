...
--Selective Flotation of Ore for Concentrating
{
	type = "technology",
	name = "flotation",
	icon = "__xander-mod__/graphics/technology/organic/flotation.png",
	icon_size = 128,
	effects =
	{
		{
	...
	prerequisites = {"ore-processor_1", "electrolysis-salt-water", "sulfur-processing", "organics_2"},
	unit =
	{
		count = 200,
		ingredients =
