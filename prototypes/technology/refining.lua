...
data.raw.technology["oil-processing"].prerequisites = {"pumpjack", "distillation-column", "reactor_1"}
...
--Fluorine Processing (Compounds only, not the pure element.)
{
	...
	prerequisites = {"blasting", "flotation", "reactor_1", "sulfuric-acid-a"},
	unit =
	{
		count = 250,
		ingredients =
...
--Phosphorus Processing
{
	...
	prerequisites = {"blasting", "flotation", "sulfuric-acid-a"},
	unit =
	{
		count = 150,
		ingredients =
...
--Nickel Refining
{
	...
	prerequisites = {"blasting", "ore-processor_1", "calcium-processing"},
	unit =
	{
		count = 200,
		ingredients =
...
--Platinum Refining
{
	...
	prerequisites = {"blasting", "flotation", "boron-processing"},
	unit =
	{
		count = 300,
		ingredients =
...
--Tungsten Refining
{
	...
	prerequisites = {"flotation", "furnace_4", "electrolysis-salt-water", "advanced-material-processing-2"},
	unit =
	{
		count = 300,
		ingredients =
...
--Gold Refining
{
	...
	prerequisites = {"flotation", "advanced-material-processing-2", "electrolysis-salt-water", "calcium-processing"},
	unit =
	{
		count = 250,
		ingredients =
...
--Chromium Refining
{
	...
	prerequisites = {"flotation", "electrolysis-salt-water", "magnesium-refining"},
	unit =
	{
		count = 400,
		ingredients =
...
--Silver Refining
{
	...
	prerequisites = {"flotation", "electrolyzer_1", "nitric-acid-a"},
	unit =
	{
		count = 200,
		ingredients =
...
--Zinc Refining
{
	...
	prerequisites = {"blasting", "flotation", "furnace_4", "electrolyzer_1"},
	unit =
	{
		count = 150,
		ingredients =
...
--Chalcopyrite Processing
{
	...
	prerequisites = {"blasting", "ore-processor_1", "furnace_4"},
	unit =
	{
		count = 250,
		ingredients =
...
--Rare Earth (RE) Refining
{
	...
	prerequisites = {"blasting", "flotation", "haber-process", "magnesium-refining"},
	unit =
	{
		count = 300,
		ingredients =
...
--Uranium Refining
{
	...
	prerequisites = {"blasting", "ore-processor_1", "nitric-acid-b", "fluorine-processing"},
	unit =
	{
		count = 300,
		ingredients =
