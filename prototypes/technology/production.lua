...
data.raw.technology["advanced-material-processing"].effects = {{type = "unlock-recipe", recipe = "brick-clay-graphite"}, 
...
--Ore Plant
{
	...
	prerequisites = {"ore-processor_1", "flotation", "pump_2"},
	unit =
	{
		count = 450,
		ingredients =
...
--Refining Furnace
{
	...
	prerequisites = {"advanced-material-processing", "electronics", "pump_1"},
	unit =
	{
		count = 250,
		ingredients =
