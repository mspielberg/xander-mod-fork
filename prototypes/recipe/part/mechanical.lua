...
--Alloy Steel Forging A
{
	...
	energy_required = 32,
	enabled = false,
	ingredients = {{"forging-steel", 4}, {"nickel-plate", 4}, {"vanadium-plate", 4}, {"tungsten-powder", 8}, {"graphite-powder", 2}},
...
--Alloy Steel Bearing
{
	...
	energy_required = 8,
	enabled = false,
	ingredients = {{"forging-alloy", 4}, {"graphite-powder", 4}, {type = "fluid", name = "lubricant", amount = 20}},
	result = "bearing-2",
	result_count = 8
},
