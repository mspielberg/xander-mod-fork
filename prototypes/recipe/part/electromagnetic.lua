...
data.raw.recipe["electric-engine-unit"].ingredients = {{"coil-1", 2}, {"shaft-0", 1}, {"forging-iron", 1}, {"copper-cable", 4}}
...
--Bruched Motor B
{
	...
	energy_required = 1,
	enabled = false,
	ingredients = {{"coil-1", 2}, {"shaft-1", 1}, {"forging-iron", 1}, {"electronic-circuit", 1}},
...
--Brushless Motor
{
	...
	energy_required = 4,
	enabled = false,
	ingredients = {{"coil-2", 2}, {"shaft-2", 1}, {"forging-aluminum", 1}, {"advanced-circuit", 1}},
	result = "motor-2"
},
--Induction Motor
{
	...
	energy_required = 5,
	enabled = false,
	ingredients = {{"coil-3", 2}, {"shaft-3", 1}, {"forging-titanium", 1}, {"advanced-circuit", 2}},
	result = "motor-3"
},
--
