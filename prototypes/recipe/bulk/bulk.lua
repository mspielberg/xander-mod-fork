...
data.raw.recipe["sulfuric-acid"].energy_required = 40
...
--Clay-Graphite Refractory Brick
{
	...
	energy_required = 4,
	enabled = false,
	ingredients = {{"clay", 1}, {"graphite-powder", 1}},
...
--Flotation Surfactant
{
	type = "recipe",
    name = "surfactant",
	icon = "__xander-mod__/graphics/recipe/organic/surfactant.png",
	category = "chemistry",
	energy_required = 20,
	enabled = false,
